...
class ManifestsControllerTest < ActionController::TestCase
  ...
  test "should create manifest" do
    assert_difference('Manifest.count') do
      post :create, manifest: { destination: @manifest.destination, notes: @manifest.notes, origin: @manifest.origin, total_weight: @manifest.total_weight }
    end
  ...
  test "should update manifest" do
    patch :update, id: @manifest, manifest: { destination: @manifest.destination, notes: @manifest.notes, origin: @manifest.origin, total_weight: @manifest.total_weight }
    assert_redirected_to manifest_path(assigns(:manifest))
  end
